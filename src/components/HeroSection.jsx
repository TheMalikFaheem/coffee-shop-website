...
export default function HeroSection({ activeProduct, onAddToCart }) {
  return (
    <section className="relative min-h-screen pt-28 pb-12 flex items-center justify-center overflow-hidden bg-brand-dark px-4 md:px-8 max-w-7xl mx-auto w-full select-none">
